...
class Model(nn.Module):
    def __init__(self, n_features, batch_size):
        ...
        self.Aggregate = Aggregate(len_feature=2048)  ## len_feature=2048   ali
        ...
        self.args = option.parser.parse_args()   ##add Ali
    ...
    def forward(self, inputs):
        ...
        if(self.args.dataset=='other'): ## add ali when we have no 10 crop

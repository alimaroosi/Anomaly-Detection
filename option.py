...
parser.add_argument('--rgb-list', default='list/Other_Train_abNorm.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/Other_Test_Norm_abNorm.list', help='list of test rgb features ')
parser.add_argument('--gt', default='list/gt-other.npy', help='file of ground truth ')
...
parser.add_argument('--batch-size', type=int, default=1, help='number of instances in a batch of data (default: 16)')
...
parser.add_argument('--dataset', default='other', help='dataset to train on (default: )')
parser.add_argument('--plot-freq', type=int, default=10, help='frequency of plotting (default: 10)')
parser.add_argument('--max-epoch', type=int, default=50, help='maximum iteration to train (default: 100)') #default=15000

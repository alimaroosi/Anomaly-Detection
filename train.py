...
def train(nloader, aloader, model, batch_size, optimizer, viz, device):
    with torch.set_grad_enabled(True):
        ...
        ninput, nlabel = next(nloader)  # (32,10,32,2048)
        ...
        scores = scores.view(batch_size * 32 * 2, -1) #(64,32,1)-->(2048,1)

        scores = scores.squeeze() #-->(2048)
        abn_scores = scores[batch_size * 32:] #(1024)
